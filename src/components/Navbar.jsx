  ...
  return (
    ...
    <nav className="bg-zinc-950 border-b border-zinc-900 sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        {/* CodiAI Logo - Adjusted gradient for dark background */}
        <Link
          to="/home"
          className="text-2xl font-bold tracking-tighter transition 
             bg-gradient-to-r from-white via-sky-500 to-sky-800 
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className="bg-zinc-100 text-black text-xs font-bold px-4 py-2 rounded-full hover:bg-sky-600 hover:text-white transition-all duration-300"
          >
            SIGN OUT
          </button>
        </div>
