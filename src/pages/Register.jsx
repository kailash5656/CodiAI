// Register.jsx
// This is the REGISTER (Sign Up) page for CodiAI.
...
function Register() {
  return (
    // Applied the CodiAI dark background (#050505)
    <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center px-4">

      {/* Brand Header */}
      <div className="mb-6 text-center">
        <h1 className="text-3xl font-bold tracking-tighter bg-gradient-to-r from-white via-sky-500 to-sky-800 bg-clip-text text-transparent">
          CodiAI
        </h1>
      </div>
      ...
      <p className="mt-6 text-zinc-400 text-sm">
        ...
        <Link to="/" className="text-sky-500 font-semibold hover:text-sky-400 transition">
          Sign in here
        </Link>
      </p>
    </div>
